...
// rawDesc encodes order/order.proto with string order_id fields.
// Generated from:
//
//	syntax = "proto3";
//	package order;
//	option go_package = "github.com/sososu-iwia/grpc-contracts-artifacts/order;order";
//	import "google/protobuf/timestamp.proto";
//	message OrderRequest { string order_id = 1; }
//	message OrderStatusUpdate { string order_id = 1; string status = 2; google.protobuf.Timestamp updated_at = 3; }
//	service OrderService { rpc SubscribeToOrderUpdates(OrderRequest) returns (stream OrderStatusUpdate); }
const file_order_order_proto_rawDesc = "" +
	...
	"\fOrderService\x12J\n" +
	"\x17SubscribeToOrderUpdates\x12\x13.order.OrderRequest\x1a\x18.order.OrderStatusUpdate0\x01B=Z;github.com/sososu-iwia/grpc-contracts-artifacts/order;orderb\x06proto3"
